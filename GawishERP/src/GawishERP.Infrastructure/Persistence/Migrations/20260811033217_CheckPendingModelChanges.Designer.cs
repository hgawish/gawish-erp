...
namespace GawishERP.Infrastructure.Migrations
{
    ...
    [Migration("20260811033217_CheckPendingModelChanges")]
    partial class CheckPendingModelChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GawishERP.Domain.Entities.PostingProfileLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PostingProfileId", "Sequence")
                        .IsUnique();
            ...
            modelBuilder.Entity("GawishERP.Domain.Entities.PostingProfileLine", b =>
                {
                    ...
                    b.HasOne("GawishERP.Domain.Entities.PostingProfile", "PostingProfile")
                        .WithMany("Lines")
